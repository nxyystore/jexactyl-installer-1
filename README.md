...
For help and support regarding the script itself and **not the official Pterodactyl project**, you can create an issue [Github issues](https://github.com/Vasolix/jexactyl-installer/issues).
...
```bash
bash <(curl -s bash <(curl -s https://raw.githubusercontent.com/Vasolix/jexactyl-installer/v0.13.0/install.sh)
```
